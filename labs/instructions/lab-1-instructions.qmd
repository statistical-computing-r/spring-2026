...
**You will need to accept the assignment by clicking the link in your email (account associated with GitHub) and then go to the link provided for the repository.**  
...
**Question 13** -- In the new code chunk, add the code for the graph. Be sure to include a code chunk label and alt text.  

**Question 14** -- Run your code chunk to obtain the output for your new graph.  

**Question 15** -- Create a numbered list containing:
...
**Question 16** -- Create another section header, describing the contents of
