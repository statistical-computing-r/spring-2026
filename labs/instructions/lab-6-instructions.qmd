...
tax_rev <- read_csv('https://raw.githubusercontent.com/statistical-computing-r/spring-2026/refs/heads/main/labs/instructions/data/ca_tax_revenue.csv', show_col_types = FALSE)
```
...
```{r}
#| label: ca-childcare-costs-solution
#| echo: false
...
ca_childcare <- counties |> 
  ...
  left_join(childcare_costs, by = "county_fips_code", multiple = "all")
```
...
dataset should have 58 x 11 = 638 observations.
:::
...
```{r}
#| label: add-tax-information-solution
#| echo: false
...
```{r}
#| label: recoding-county-to-census-regions-solution
#| echo: false
# Finish this code using the census regions defined above
...
```{r}
#| label: median-income-by-region-over-time-solution
#| echo: false
median_2008_2018 <- ca_childcare |>
...
```{r}
#| label: lowest-median-weekly-price-2018-solution 
#| echo: false
...
ca_childcare |>
  ...
  mutate(
    type_label = fct_recode(
      type,
      "Infant" = "mc_infant",
      "Toddler" = "mc_toddler",
      "Preschool" = "mc_preschool"
    ),
    type_label = fct_relevel(type_label, "Infant", "Toddler", "Preschool")
  ) |>
  ggplot(aes(x = study_year, 
             y = weekly_price, 
             color = fct_reorder(region, 
                                 weekly_price, 
                                 .fun = \(x) median(x[study_year == 2018], na.rm = TRUE),
                                 .desc = TRUE))) +
  ...
  scale_y_continuous(labels = scales::label_currency(), 
                     ...
                     limits = c(100, 500)) +
  scale_color_manual(values = c("#89C788", "#F8D695", 
                                "#B13F91", "#3C3C3C", 
                                "#A8765A", "#D43758",
                                "#B26F89", "#CED7A3",
                                "#8B8691", "#517dac"
