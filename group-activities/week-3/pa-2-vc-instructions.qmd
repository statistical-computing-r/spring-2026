...
5. The Computer should then create a Version Control R Project on their computer and then download the [`pa-2-vc-intro-tidy-activity.qmd](pa-2-vc-intro-tidy-activity.qmd) file into the folder on your computer.
