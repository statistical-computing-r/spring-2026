...
<!-- Took way more time than anticipated - need to reduce front end and move it to the end. -->
...
2. completed [pa-5-dplyr-reshaping-activity.qmd](../week-6/pa-5-dplyr-reshaping-activity.qmd) 
...
<!-- NEed to fix this one - I had originally filtered == 3, it should be to exclude these two - need to check -->
...
colleges_clean2 <- colleges_clean1 |> 
  filter(control == 1) #double = needed
```
...
colleges_clean5 <- colleges_clean2 |> 
...
<!-- Clarify they need to start with full data set -->
