...
Identify the right function name that removes every row with missing data.
...
5.  This college is located in the contiguous 48 states. This should be one argument.
