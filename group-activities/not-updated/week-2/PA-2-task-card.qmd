...
When you are the **Computer**, you will type into the Quarto document in
...
instructions / prompts and directing the Computer what to type in the Quarto
...
with the Computer to debug the code you specified. Once the code runs, you
are expected to collaborate with the Computer to write code comments that
